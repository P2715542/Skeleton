...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnReturnToMainMenu" runat="server" OnClick="btnReturnToMainMenu_Click" style="z-index: 1; left: 326px; top: 350px; position: absolute" Text="Return to Main Menu" />
    </form>
</body>
</html>
