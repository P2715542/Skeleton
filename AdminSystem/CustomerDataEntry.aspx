...
<body style="height: 392px">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblPassword" runat="server" style="z-index: 1; left: 14px; top: 174px; position: absolute" Text="Password"></asp:Label>
        <asp:TextBox ID="txtPassword" runat="server" style="z-index: 1; left: 115px; top: 175px; position: absolute" height="22px" width="128px"></asp:TextBox>
        <asp:Label ID="lblAccountCreated" runat="server" style="z-index: 1; left: 14px; top: 212px; position: absolute" Text="Account Created" height="19px" width="92px"></asp:Label>
        <asp:Button ID="btnOK" runat="server" style="z-index: 1; left: 21px; top: 324px; position: absolute" Text="OK" OnClick="btnOK_Click" />
        <asp:TextBox ID="txtAccountCreated" runat="server" style="z-index: 1; left: 115px; top: 213px; position: absolute" height="22px" width="128px"></asp:TextBox>
